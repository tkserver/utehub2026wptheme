    ...
    <div class="post-wrap">
        <article class="post op">
            ...
            <div class="pbody">
                ...
                <a class="reply-link" href="#new-reply-<?php echo esc_attr( $topic_id ); ?>"><?php echo utehub2026_get_svg( 'reply' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>Reply</a>
            </div>
        </article>
    </div>
</div>
